...
interface MovieService {
    @GET("movie/top_rated")
    suspend fun getTopRatedMovies( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("movie/upcoming")
    suspend fun getUpcomingMovies( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("movie/now_playing")
    suspend fun getNowPlayingMovies( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("movie/popular")
    suspend fun getPopularMovies( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("tv/popular")
    suspend fun getPopularSeries( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("tv/top_rated")
    suspend fun getTopRatedSeries( @Query("page") pageIndex: Int): Response<MovieResponse>

    @GET("tv/on_the_air")
    suspend fun getOnTheAirSeries( @Query("page") pageIndex: Int): Response<MovieResponse>
